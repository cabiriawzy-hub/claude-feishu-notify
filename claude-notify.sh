...
humanize_bash() {
  ...
  case "$c" in
    ...
    "ln "*)                             echo "做快捷方式" ;;
    "lark-cli docs +fetch"*|"lark-cli docs +search"*|"lark-cli docs +media-preview"*|"lark-cli docs +media-download"*) echo "看飞书文档" ;;
    "lark-cli docs"*)                   echo "改飞书文档" ;;
    "lark-cli wiki"*)                   echo "操作飞书 Wiki" ;;
    "lark-cli minutes"*)                echo "看飞书会议记录" ;;
    "lark-cli vc"*)                     echo "看飞书会议信息" ;;
    "lark-cli whiteboard"*)             echo "操作飞书画板" ;;
    "lark-cli im +messages-send"*|"lark-cli im messages send"*) echo "发飞书消息" ;;
    "lark-cli im +messages-reply"*|"lark-cli im messages reply"*) echo "回复飞书消息" ;;
    "lark-cli im +chat-create"*|"lark-cli im +chat-update"*) echo "操作飞书群" ;;
    "lark-cli im +messages-resources-download"*) echo "下载飞书附件" ;;
    "lark-cli im"*)                     echo "看飞书消息" ;;
